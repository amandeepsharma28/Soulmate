<?php
  ...
  if(isset($_SESSION['userId'])) {
    ...
    $queryStr="select r.user_id,r.name, p.interest,p.image, p.age, p.country from register r, profile p where r.user_id = p.user_id and p.interest='$interest' and r.user_id != '$userId' order by user_id desc limit 10";

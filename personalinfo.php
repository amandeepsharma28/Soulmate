<?php require_once("header.php");?>
        <section class="left" id="left">
            <div class="quotes">
                <p>
                    <h1>Fill your personal information here to know you better...</h1><br>
                </p>
            </div>
        </section>
        <section class="right" id="right">
            <div class="register">
                <form action="addpersonalinfo.php" id="personalinfo" method="post" enctype="multipart/form-data">
                    <fieldset>
                        <legend>
                            <h1>Profile</h1>
                        </legend>
                        ...
                        <select class="dob month" name="month" id="date" required title="Please select the month">
                            <option>Month</option>
                        ...
                        <select class="dob day" name="day" id="date" required title="Please select the day">
                            <option>Day</option>
                        ...
                        <select class="dob year" name="year" id="date" required title="Please select the year">
                            <option>Year</option>
                        ...
                        <input type="text" class="textbox" name="age" id="age" required title="Please enter your age" />
                        <br>
                        <br>
                        ...
                        <input type="text" class="textbox" name="country" id="country" required title="Enter your country"/>
                        <br>
                        <br>
